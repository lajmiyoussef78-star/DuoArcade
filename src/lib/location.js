...
/** Phone GPS is noisy indoors (~20–50 m). Treat that band as "together". */
export const GEO_NOISE_KM = 0.05; // 50 m ≈ 164 ft

export function formatDistance(km) {
  if (!(km >= 0) || Number.isNaN(km)) return '—';
  if (km < GEO_NOISE_KM) return '0 ft';
